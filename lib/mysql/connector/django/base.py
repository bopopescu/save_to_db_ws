...
try:
    ...
    from lib.mysql import MySQLConverter, MySQLConverterBase
    from lib.mysql import PY2
...
try:
    version = lib.mysql.connector.__version_info__[0:3]
except AttributeError:
    from lib.mysql import VERSION
    version = VERSION[0:3]
...
if version < (1, 1):
    ...
    raise ImproperlyConfigured(
        ...
        "is required; you have %s" % lib.mysql.connector.__version__)
...
from lib.mysql import DatabaseClient
from lib.mysql import DatabaseCreation
from lib.mysql import DatabaseIntrospection
from lib.mysql import DatabaseValidation
from lib.mysql import DatabaseFeatures
from lib.mysql import DatabaseOperations
if django.VERSION >= (1, 7):
    from lib.mysql import DatabaseSchemaEditor


DatabaseError = lib.mysql.connector.DatabaseError
IntegrityError = lib.mysql.connector.IntegrityError
NotSupportedError = lib.mysql.connector.NotSupportedError
...
class CursorWrapper(object):
    ...
    def _execute_wrapper(self, method, query, args):
        ...
        except lib.mysql.connector.DatabaseError as err:
            six.reraise(utils.DatabaseError,
                        utils.DatabaseError(err.msg), sys.exc_info()[2])
...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    def get_connection_params(self):
        ...
        kwargs['client_flags'] = [
            ...
            lib.mysql.connector.constants.ClientFlag.FOUND_ROWS,
        ]
        try:
    ...
    def get_new_connection(self, conn_params):
        ...
        cnx = lib.mysql.connector.connect(**conn_params)
    ...
    def mysql_version(self):
        ...
        temp_conn = lib.mysql.connector.connect(**config)
